      ...
      <div className="w-[250px] bg-[#1055AE] text-white flex flex-col h-full">
        ...
        <nav className="flex-1">
          <ul className="space-y-1">
            ...
            <li>
              <Link href="/prescription" className="flex items-center gap-3 px-4 py-3 hover:bg-[#0d4690] text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">Pending</span>
                    </div>
                  </div>
                </div>
